...
Twisty Timer es una aplicación web profesional orientada al *speedcubing*, diseñada específicamente para el entrenamiento del método CFOP con la capacidad de registrar splits manuales por fase (Cross, F2L, OLL, PLL). 
